...
class _HomeTodoState extends State<HomeTodo> {
  ...
  Widget build(BuildContext context) {
    context.watch<TaskProvider>().tasks.cast<Task>();
                    ...
                    itemBuilder: (context, index) {
                      if (!filteredTasks.elementAt(index).isDone) {
                        return GestureDetector(
                          onTap: (){
                            Navigator.push(context, createSlideTransitions(newPage: DetailTodo(idTodo: filteredTasks.elementAt(index).id), x: 1.0, y: 0.0,));
                          },
                          child: CardTodo(
                              tasks: filteredTasks,
                              index: index,
                        ...
                        return GestureDetector(
                          onTap: (){
                            Navigator.push(context, createSlideTransitions(newPage: DetailTodo(idTodo : filteredTasks.elementAt(index).id), x: 1.0, y: 9.0,));
                          },
                          child: CardTodo(
                              tasks: filteredTasks,
                              index: index,
